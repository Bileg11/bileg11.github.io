...
• Газар: Bund (Вайтань), Yu Garden, Tianzifang, French Concession, Xintiandi, Nanjing Road, Zhujiajiao усан тосгон, Disneyland, Oriental Pearl.
• Цаг агаар: 2026.06 — Meiyu (梅雨) борооны улирал, чийглэг бүгчим, бороо ойр ойрхон. Шүхэр/нимгэн нөмрөг хэрэгтэй.
• Хоол: xiaolongbao, shengjianbao, hairy crab, Шанхай маягийн нudle; Yang's, Jia Jia Tang Bao зэрэг алдартай.
...
• Төгсгөл — value постод зөөлөн дүгнэлт; service постод л CTA. Пост бүрт ӨӨР найруулгаар, давтахгүй.
• CTA: "👉 lfsshanghai.com руу орж үнэгүй зөвлөгөө авна уу" + #LFSShanghai + сэдэвт тохирсон 2 латин хаштаг.

ХАТУУ ХОРИГ: дугаарласан жагсаалт (1. 2. / 1️⃣), "Манай платформд/Манайхаар үйлчлүүлж буй", гуравдагч этгээдийн "таны аялагчдад", үнэ/тоо баримт, техникийн тэмдэглэгээ, хоосон богино параграф, 3 пост дээр давтагдсан өгүүлбэр. Параграф бүр бүтэн, амьд.

ДААЛГАВАР: Доорх сэдэв/контекстод тааруулж дээрх дүрмээр пост үүсгэ: [INPUT_PROMPT]
`;

// ── CONTENT PILLARS ───────────────────────────────────────────────
// Value pillar = цэвэр Шанхай контент (хүн татах). Service pillar = LFS үйлчилгээ.
// Ихэвчлэн 2 value + 1 service сонгож, "зар" биш "контент" тэнцвэр барина.
const CONTENT_PILLARS = {
  value: [
    ...
    '💳 ПРАКТИК ЗӨВЛӨГӨӨ: Alipay/WeChat Pay-д Монгол карт холбох, Metro карт, DiDi такси, eSIM, орчуулгын апп — Шанхайд төвөггүй явах амьд зөвлөмжүүд.',
  ],
  service: [
    '🏥 ЭРҮҮЛ МЭНД (зөөлөн upsell): аяллынхаа хажуугаар Guangming TCM-ийн VIP тасагт очергүй 2-3 цагт биеэ оношлуулах, Монгол орчуулагчтай. Аялал суурь, оношилгоо ухаалаг нэмэлт.',
...
// 2 value + 1 service pillar-ийг санамсаргүй сонгож, дарааллыг холино
function pickPillars() {
  ...
  return [...v, s].sort(() => Math.random() - 0.5);
}
...
async function generateMarketingIdeas() {
  ...
  const task =
    ...
    `Value сэдэвт пост = цэвэр хэрэгтэй контент, LFS-ийг зөвхөн доор зөөлөн дурд. Service сэдэвт пост = үйлчилгээгээ гол болго.\n` +
