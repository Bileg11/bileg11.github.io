...
• Шинжилгээ + Аялал багц (5ө/4шө): 23 төрлийн шинжилгээ + хөтөч + хоол + угтаа/хүргэлт. Нислэг, 5 одтой буудал үнэд багтсан.
• Энгийн шинжилгээний багц (1ө): зөвхөн суурь шинжилгээ, нислэг ба аялал ороогүй.
• Зөвхөн аяллын багц (5ө/4шө): дээдтэй ижил (нислэг, 5 одтой буудал, хоол) — шинжилгээгүй, амьтны хүрээлэнгийн оронд Disneyland.
...
• Гол агуулга — сэдвийн бодит, хэрэгтэй мэдээллийг амьд хэлээр 2-4 өгүүлбэр. Хэрэв хэд хэдэн газар/цэг/зүйл нэрлэвэл тус бүрийг ТУСДАА МӨРӨНД (\\n) салгаж, эхэнд нь 📍 тавьж бич — англи/хятад/монгол нэр холилдсон тул нэг урт параграфт шахвал уншихад хэцүү. Жишээ: "📍 The Bund (外滩) — оройн skyline\\n📍 Yu Garden (豫园) — уламжлалт цэцэрлэг".
...
ХАТУУ ХОРИГ: дугаарласан жагсаалт (1. 2. 3. / 1️⃣2️⃣) хориотой — газар жагсаахдаа дугаарын оронд 📍 + мөр салгалт ашигла; "Манай платформд/Манайхаар үйлчлүүлж буй", гуравдагч этгээдийн "таны аялагчдад", үнэ/тоо баримт, техникийн тэмдэглэгээ, хоосон богино параграф, 3 пост дээр давтагдсан өгүүлбэр, газар/хоолны нэрийг монголоор галиглах — бүгд хориотой. Найруулга амьд, хүн бичсэн мэт.
...
const CONTENT_PILLARS = {
  value: [
    ...
    '🛍️ ШОППИНГ ГАЙД: Nanjing Road (南京路) явган гудамж, Qipu Road (七浦路) бөөний хувцасны зах, South Bund Fabric Market (хувцас захиалж оёх), Tianzifang (田子坊) бэлэг дурсгал. Хаана хямд, наймаа хийх зөвлөгөө.',
    '🚄 ОЙРХОН АЯЛАЛ: галт тэргээр 30-60 минутын зайд Suzhou (苏州, суваг ба сонгодог цэцэрлэгүүд) болон Hangzhou (杭州, West Lake 西湖). Шанхайгаас нэг өдрийн зугаалга хийх боломж.',
    '☕ КОФЕ & ЗАЛУУ СОЁЛ: Шанхай бол Хятадын кофены нийслэл — French Concession (法租界)-ийн бутик кофе шоп, brunch газрууд, загварлаг шинэ дүүргүүд.',
    '📸 ФОТО ЦЭГ: Instagram-д тохирох газрууд — The Bund (外滩) skyline, Wukang Mansion (武康大楼), Tianzifang (田子坊) нарийн гудамж, Lujiazui (陆家嘴) шөнийн неон гэрэл.',
    '🚇 ХОТООР ЗОРЧИХ: Metro (хямд, өргөн сүлжээ), Maglev (磁悬浮) нисэх буудлын хурдан галт тэрэг, DiDi такси, хувьцаат унадаг дугуй — хотоор хэрхэн хялбар зорчих.',
  ],
  trust: [
