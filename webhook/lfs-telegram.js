...
2. Эмнэлэг: Huashan (18:00 цагт цаг нь нээгддэг, 14 хоногийн өмнө захиална), Ruijin (өглөө 7:30-д дугаарладаг, 4 долоо хоногийн өмнө цаг хаагддаг), Parkway (олон улсын англи хэлтэй, даатгалтай, үнэ өндөр). Нарийн оношилгоо дунджаар ажлын 2-4 өдөр үргэлжилдэг.
...
2. Текстийг нэг том цул блок болгож нааж БОЛОХГҮЙ. Уншихад хялбар болгох үүднээс догол мөр (paragraph) бүрийн хооронд заавал яг 1 хоосон мөр (line break / double enter) авч тусгаарла.
3. Нэг пост дотор Өнцгүүдийг хооронд нь БҮҮ ХОЛЬ. Асуултын хариулт (Өнцөг А), эсвэл Бодит кэйс (Өнцөг Б)-ийн аль нэгийг сонгосон бол пост дуустал зөвхөн тэр логикоор явна. "Дорж, Болор" гэх мэт зохиомол нэр бүү зохио.
4. Постын төгсгөлд 15-20 ширхэг замбараагүй хаштаг цуглуулахыг ХАТУУ ХОРИГЛОНО. Хамгийн төгсгөлд зөвхөн 2-3 ширхэг цэвэрхэн хаштаг тавь.
...
async function generateMarketingIdeas() {
  ...
  const userPrompt =
    ...
    `Пост бүр нь дараах 3 өнцгийн ЯГ НЭГ дээр суурилсан ЭССЭ байна:\n` +
    `  - Өнцөг А: "Манай платформд хандаж буй аялагчдын хамгийн их асуулт бол [яг тодорхой асуулт]..." — хариулт нь постын гол агуулга\n` +
    `  - Өнцөг Б: "Манайхаар үйлчлүүлж буй нэг гэр бүлд яг ийм зүйл тохиолдлоо..." — нэр дурдахгүй, бодит нөхцөл байдал тайлбарла\n` +
    `  - Өнцөг В: Шанхайн БОДИТ газрын нэр ашиглан (Huashan, Bund, Yu Garden, Xintiandi...) тэнд явж байгаа мэт\n\n` +
    `caption талбарт шууд уншигдахуйц урт эссэ бич:\n` +
    `  - "Hook:", "Caption:", "Tags:" гэсэн хэсэг ОГТХОН ч байхгүй\n` +
    `  - Догол мөр бүрийн хооронд \\n\\n (хоосон мөр) ашигла — нэг блок болгож битгий бич\n` +
    `  - Эхний өгүүлбэрээс шууд эхэл, дуусгах өгүүлбэртэй байлга\n` +
    `  - Мэдлэгийн санд байх бодит тоо баримт ашигла (18:00, 14 хоног, 3%, 350-500 юань гэх мэт)\n` +
    ...
    `    "format": "single|carousel|reel",\n` +
    `    "caption": "Догол мөр бүр \\n\\n-ээр тусгаарлагдсан пост текст, CTA оролцуулан",\n` +
    `    "hashtags": "#LFSShanghai #ШанхайЭмнэлэг (Кирилл эсвэл англи — транслит хориотой)",\n` +
