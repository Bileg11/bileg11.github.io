...
async function generateMarketingIdeas() {
  ...
  const task =
    ...
    `Пост бүр эхний өгүүлбэрт хэрэглэгчийн БОДИТ асуудлаас шууд эхлэх ёстой:\n` +
    `  - single: "Шанхайд ирж үзэж байхдаа эрүүл мэндийн шинжилгээ хийлгэх боломжтой гэдгийг мэдэх үү?" гэх мэтийн шууд асуулт эсвэл баримт\n` +
    `  - carousel: "Хятад руу эрүүл мэндийн шинжилгээнд явахаар төлөвлөж байгаа бол эхлээд мэдэх ёстой зүйлүүд:" гэх мэтийн слайд татах эхлэл\n` +
    `  - reel: "Шанхайн эмнэлэгт цаг аваад үзүүлэхэд хэлний бэрхшээлтэй тулгарвал яах вэ?" гэх мэтийн шууд асуулт\n\n` +
    `caption талбар — шууд уншигдахуйц урт эссэ:\n` +
    `  - Догол мөр бүрийг \\n\\n литерал тэмдэгтээр тусгаарла\n` +
    `  - Зөвхөн Guangming-д хамаарах өгөгдөл (2-3 цаг, VIP, Монгол орчуулагч) ашигла\n` +
