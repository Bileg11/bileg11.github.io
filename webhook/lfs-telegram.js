...
1. Пост нь "Hook:", "Caption:", "Tags:" гэсэн хэсгүүдэд ХУВААГДАХГҮЙ. Шууд уншигчтай ярилцаж буй мэт урт, цэгцтэй догол мөрүүд бүхий цул бичвэр байна.
2. Маркетингийн улиг болсон "Урьж байна", "Гайхамшигтай", "Манай хамт олон", "Аялахад бэлэн үү?", "санал болгоно", "холбогдоорой" гэх хиймэл үгсийг БҮҮ ашигла.
3. Пост бүрийг дараах 3 өнцгийн аль нэгээр эхлүүл:
   - Өнцөг А: "Манай lfsshanghai.com чат руу хамгийн их ирдэг асуулт бол [яг тодорхой асуулт]..."
   - Өнцөг Б: "Өнөөдөр манайхаар үйлчлүүлж буй нэг гэр бүлд яг ийм зүйл тохиолдлоо..." (нэр ДУРДАХГҮЙ)
   - Өнцөг В: "Би өнөөдөр Шанхайн [Huashan/Bund/Yu Garden/Xintiandi гэх мэт БОДИТ нэр] дээр явж байна..."
4. Ruijin, Huashan — улсын эмнэлэг, хэлний бэрхшээл их. Зөвхөн Parkway нь англи хэлтэй, даатгалтай. Буруу мэдээлж болохгүй.
5. Хаштаг хамгийн ихдээ 2-3 — #LFSShanghai #Шанхай #эмнэлэг гэх мэт. 10+ хаштаг спам харагдана.
6. Пост бүрийн төгсгөлд: "👉 lfsshanghai.com руу орж үнэгүй зөвлөгөө авна уу"
`;
...
async function generateMarketingIdeas() {
  ...
  const userPrompt =
    ...
    `  - Өнцөг А: Яг тодорхой асуулт дурд (жишээ: "Ruijin-д цаг хэрхэн авах вэ?" — хариулт нь caption-д)\n` +
    `  - Өнцөг Б: Нэр ДУРДАХГҮЙ, "манайхаар үйлчлүүлж буй нэг гэр бүл" гэж эхэл\n` +
    `  - Өнцөг В: Шанхайн БОДИТ газрын нэр — Yu Garden, Huashan, Bund, Xintiandi гэх мэт\n\n` +
    `caption талбар нь БҮРЭН пост текст — Hook + тайлбар + CTA бүгд нэг цул бичвэрт багтана.\n` +
    `"Hook:", "Caption:" гэж хэсэг хуваалгүй, шууд эхний өгүүлбэрээс эхэл.\n\n` +
    `Хариу: JSON array ЗӨВХӨН (тайлбар текст хэрэггүй):\n` +
    `[\n` +
    `  {\n` +
    `    "title": "Постын нэр (Монголоор)",\n` +
    `    "format": "single|carousel|reel",\n` +
    `    "caption": "400-550 тэмдэгт — storytelling эхлэл + тайлбар + CTA бүгд нэг бичвэрт, emoji 3-5",\n` +
    `    "hashtags": "#LFSShanghai + хамгийн ихдээ 2 нэмэлт хаштаг",\n` +
