...
async function generateMarketingIdeas() {
  ...
  const userPrompt =
    ...
    `  - Өнцөг А: "Манай lfsshanghai.com чат руу хамгийн их ирдэг асуулт бол..."\n` +
    `  - Өнцөг Б: "Өнөөдөр манайхаар үйлчлүүлж байгаа нэг Монгол гэр бүлд яг ийм зүйл тохиолдлоо..."\n` +
    `  - Өнцөг В: "Би өнөөдөр Шанхайн [тодорхой газрын нэр] дээр явж байна..."\n\n` +
    `Хариу: JSON array ЗӨВХӨН (тайлбар текст хэрэггүй):\n` +
    `[\n` +
    `  {\n` +
    `    "title": "Постын нэр",\n` +
    `    "format": "single|carousel|reel",\n` +
    `    "hook": "Анхны 1-2 өгүүлбэр — уншигчийг зогсоох хүч, 60-100 тэмдэгт",\n` +
    `    "caption": "350-500 тэмдэгт, амьд урт өгүүлбэрүүд, emoji, storytelling",\n` +
    `    "cta": "👉 lfsshanghai.com руу орж үнэгүй зөвлөгөө авна уу",\n` +
    `    "hashtags": "#LFSShanghai + 12 холбогдох тэмдэглэгээ",\n` +
